...
![Session Authentication](./images/Session%20Authentication.png)
...
Copy all your work of the [0x06. Basic authentication](../Basic_authentication) project in this new folder.
...
### [8. Logout](./api/v1/views/session_auth.py)
